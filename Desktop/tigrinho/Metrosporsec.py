...
velocidadefinal= round((velocidademedia/3.6))
print (f'Sua velocidade em quilômetros por hora é equivalente a {velocidademedia}km/h!') 
print (f'Portanto, ao converter o valor da velocidade média pra metros por segundos, você recebe o valor final de {velocidadefinal} metros por segundo!')